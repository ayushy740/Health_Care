  ...
  const socialLinks = [
    {
      ...
      name: "Facebook",
      href: "https://github.com/ayushy740",
    },
    {
      Icon: Twitter,
      color: footerStyles.twitterColor,
      name: "Twitter",
      href: "https://x.com/AyushYadav7026",
    },
    {
      Icon: Instagram,
      color: footerStyles.instagramColor,
      name: "Instagram",
      href: "https://www.instagram.com/_ayush_yadav_9120",
    },
    {
      Icon: Linkedin,
      color: footerStyles.linkedinColor,
      name: "LinkedIn",
      href: "https://www.linkedin.com/in/ayush-yadav-71701b250",
    },
    {
      Icon: Youtube,
      color: footerStyles.youtubeColor,
      name: "YouTube",
      href: "https://youtu.be/dQw4w9WgXcQ?si=TteWaibbaK3LfNnB",
    },
  ];
        ...
        <div className={footerStyles.gridContainer}>
          ...
          <div className={footerStyles.companySection}>
            <div className={footerStyles.logoContainer}>
              ...
              <div>
                <h2 className={footerStyles.companyName}>Decent</h2>
            ...
            <div className={footerStyles.contactContainer}>
              <div className={footerStyles.contactItem}>
                ...
                <span className={footerStyles.contactText}>+91 9120418059</span>
              </div>
              <div className={footerStyles.contactItem}>
                <div className={footerStyles.contactIconWrapper}>
